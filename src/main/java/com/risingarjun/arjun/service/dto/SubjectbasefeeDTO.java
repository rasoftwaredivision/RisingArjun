...
/**
 * A DTO for the {@link com.risingarjun.arjun.domain.Subjectbasefee} entity.
 */
public class SubjectbasefeeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SubjectbasefeeDTO subjectbasefeeDTO = (SubjectbasefeeDTO) o;
        if (subjectbasefeeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), subjectbasefeeDTO.getId());
    }
