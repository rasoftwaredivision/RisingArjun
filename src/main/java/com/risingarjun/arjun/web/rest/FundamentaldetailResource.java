...
public class FundamentaldetailResource {
    ...
    public ResponseEntity<List<FundamentaldetailDTO>> getAllFundamentaldetails(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of Fundamentaldetails");
        Page<FundamentaldetailDTO> page = fundamentaldetailService.findAll(pageable);
