...
public class CenterResource {
     ...
     */
    @GetMapping("/centers")
    public ResponseEntity<List<CenterDTO>> getAllCenters(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
