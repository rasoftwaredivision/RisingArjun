...
public class CourseResource {
     ...
     */
    @GetMapping("/courses")
    public ResponseEntity<List<CourseDTO>> getAllCourses(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
