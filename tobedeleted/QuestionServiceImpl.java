...
public class QuestionServiceImpl implements QuestionService {
	...
	@Override
	public List<Question> getQuestionsForTestPaper(TestpaperDTO testpaperdto) {
		// TODO Auto-generated method stub
		Set<TopicDTO> topics=testpaperdto.getTopics();
		ArrayList<Long> topicids=new ArrayList<Long>();
		for(TopicDTO temp:topics)
		{
			topicids.add(temp.getId());
		}
		
		return	questionRepository.getquestionsForTestPaper(testpaperdto.getLevel(),testpaperdto.getSubjectId(),topicids,testpaperdto.getCourseId());
